...
namespace Entidades
{
    ...
    public abstract class Vehiculo
    {
        ...
        /// <summary>
        /// Sobreescribe el operador string
        /// </summary>
        ...
        /// <returns>True si los chasis son iguales, False si no lo son</returns>
        ...
        /// <param name="v1">Vehiculo 1</param>
        /// <param name="v2">Vehiculo 2</param>
        /// <returns>False si los chasis son iguales, True si no lo son</returns>
        public static bool operator !=(Vehiculo v1, Vehiculo v2)
        {
            return !(v1.chasis == v2.chasis);
        }
